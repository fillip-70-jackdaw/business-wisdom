...
function AnalysisSkeleton() {
  return (
    <div className="animate-pulse space-y-4">
      <div className="h-4 bg-[rgba(216,179,124,0.1)] rounded w-1/3" />
      <div className="space-y-2">
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-full" />
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-5/6" />
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-4/5" />
      </div>
      <div className="h-4 bg-[rgba(216,179,124,0.1)] rounded w-1/4 mt-6" />
      <div className="space-y-2">
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-full" />
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-3/4" />
      </div>
      <div className="h-4 bg-[rgba(216,179,124,0.1)] rounded w-2/5 mt-6" />
      <div className="space-y-2">
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-full" />
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-5/6" />
        <div className="h-3 bg-[rgba(216,179,124,0.08)] rounded w-2/3" />
      </div>
    </div>
  );
}
...
export function BusinessStyleAnalysis({ nuggets }: BusinessStyleAnalysisProps) {
  ...
  return (
    <motion.div
      ...
      className="rounded-2xl border border-[var(--border)] p-6 md:p-8"
      style={{
        background: `
          radial-gradient(ellipse 90% 70% at 50% 45%, rgba(247, 232, 208, 0.04) 0%, transparent 60%),
          linear-gradient(145deg, var(--card-surface-light), var(--card-surface))
        `,
        boxShadow: `
          0 1px 0 0 rgba(247, 232, 208, 0.06) inset,
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-4">
        <div className="w-10 h-10 rounded-full bg-[rgba(216,179,124,0.1)] flex items-center justify-center">
      ...
      <AnimatePresence mode="wait">
        ...
        {!analysis && !isLoading && !error && (
          ...
          >
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-[var(--brass)] text-[var(--bg)] font-medium
                         hover:bg-[var(--tan)] transition-all duration-200
        ...
        {error && !isLoading && (
          ...
          >
            ...
            <button
              onClick={generateAnalysis}
              className="px-4 py-2 rounded-lg border border-[var(--border)] text-[var(--tan)]
                         hover:bg-[rgba(216,179,124,0.1)] transition-all duration-200
                         text-sm font-medium"
            >
              Try Again
            </button>
            ...
            <div className="mt-6 pt-4 border-t border-[var(--border)]">
              <button
                ...
                className="px-4 py-2 rounded-lg border border-[var(--border)] text-[var(--text-muted)]
                           hover:text-[var(--tan)] hover:border-[var(--border-hover)]
